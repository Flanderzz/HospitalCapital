package io.HospitalCapital.provider;
...
public class TokenProvider {
    ...
    private static final String HOSPITALCAPITAL = "HOSPITAL_CAPITAL";
    ...
    public String createAccessToken(UserPrincipal userPrincipal) {
        return JWT.create().withIssuer(HOSPITALCAPITAL).withAudience(CUSTOMER_MANAGEMENT_SERVICE)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try {
            ...
            verifier = JWT.require(algorithm).withIssuer(HOSPITALCAPITAL).build();
